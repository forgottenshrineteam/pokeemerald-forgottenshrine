...
static const struct TrainerMonNoItemCustomMoves sParty_Matt[] = {
    ...
    .moves = {MOVE_WATERFALL, MOVE_LEECH_LIFE, MOVE_AQUA_RING, MOVE_BITE}
    },
    {
    .iv = 50,
    .lvl = 34,
    .species = SPECIES_SEAKING,
    .moves = {MOVE_WATERFALL, MOVE_AGILITY, MOVE_POISON_JAB, MOVE_MEGAHORN}
    },
    {
    .iv = 50,
    .lvl = 34,
    .species = SPECIES_GOLISOPOD,
    .moves = {MOVE_RAZOR_SHELL, MOVE_X_SCISSOR, MOVE_SUCKER_PUNCH, MOVE_SLASH}
    },
    {
    .iv = 50,
    .lvl = 35,
    .species = SPECIES_POLIWRATH,
    .moves = {MOVE_WATERFALL, MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_ShellyWeatherInstitute[] = {
    ...
    .moves = {MOVE_BUBBLE_BEAM, MOVE_SWIFT, MOVE_PSYWAVE, MOVE_RECOVER}
    },
    {
    .iv = 50,
    .lvl = 28,
    .species = SPECIES_SPHEAL,
    .moves = {MOVE_BRINE, MOVE_AURORA_BEAM, MOVE_ENCORE, MOVE_GROWL}
    },
    {
    .iv = 50,
    .lvl = 29,
    .species = SPECIES_BRIONNE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_DISARMING_VOICE, MOVE_SING, MOVE_CHARM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_ShellySeafloorCavern[] = {
    ...
    .moves = {MOVE_SURF, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_THUNDERBOLT}
    },
    {
    .iv = 100,
    .lvl = 37,
    ...
    .moves = {MOVE_SPARKLING_ARIA, MOVE_DAZZLING_GLEAM, MOVE_PSYCHIC, MOVE_CHARM}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Archie[] = {
    ...
    .moves = {MOVE_CRABHAMMER, MOVE_CRUNCH, MOVE_X_SCISSOR, MOVE_SWAGGER}
    },
    {
    .iv = 150,
    .lvl = 41,
    .species = SPECIES_JELLICENT,
    .moves = {MOVE_SURF, MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 150,
    .lvl = 41,
    .species = SPECIES_LANTURN,
    .moves = {MOVE_SURF, MOVE_THUNDERBOLT, MOVE_THUNDER_WAVE, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = 150,
    .lvl = 42,
    .species = SPECIES_RELICANTH,
    .moves = {MOVE_AQUA_TAIL, MOVE_ROCK_SLIDE, MOVE_AMNESIA, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = 150,
    .lvl = 42,
    .species = SPECIES_LUDICOLO,
    .moves = {MOVE_SURF, MOVE_ENERGY_BALL, MOVE_RAIN_DANCE, MOVE_ICE_BEAM}
    },
    {
    .iv = 150,
    .lvl = 43,
    .species = SPECIES_SHARPEDO,
    .moves = {MOVE_WATERFALL, MOVE_CRUNCH, MOVE_ZEN_HEADBUTT, MOVE_POISON_JAB}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vito[] = {
    ...
    .moves = {MOVE_BRAVE_BIRD, MOVE_JUMP_KICK, MOVE_SWORDS_DANCE, MOVE_ROOST}
    },
    {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_ALAKAZAM,
    .moves = {MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_HYPNOSIS, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_ELECTIVIRE,
    .moves = {MOVE_VOLT_TACKLE, MOVE_CROSS_CHOP, MOVE_THUNDER_WAVE, MOVE_ICE_PUNCH}
    },
    {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_SHIFTRY,
    .moves = {MOVE_LEAF_BLADE, MOVE_NIGHT_SLASH, MOVE_ROCK_SLIDE, MOVE_FAKE_OUT}
    },
    {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_CENTISKORCH,
    .moves = {MOVE_FIRE_LASH, MOVE_LUNGE, MOVE_COIL, MOVE_THUNDER_FANG}
    },
    {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_POLIWRATH,
    .moves = {MOVE_WATERFALL, MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_HYPNOSIS}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEAF_BLADE, MOVE_DOUBLE_TEAM, MOVE_SWAGGER, MOVE_NIGHT_SLASH}
    },
    {
    .iv = 250,
    .lvl = 46,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_BULK_UP, MOVE_SANDSTORM}
    },
    {
    .iv = 250,
    .lvl = 48,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRABHAMMER, MOVE_SWORDS_DANCE, MOVE_CRUNCH, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_NIGHT_SLASH, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE, MOVE_SLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_FLAMETHROWER, MOVE_WILL_O_WISP, MOVE_ENERGY_BALL}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_SLUDGE_BOMB, MOVE_HYPNOSIS}
    },
    {
    .iv = 255,
    .lvl = 51,
    ...
    .moves = {MOVE_SHADOW_SNEAK, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY, MOVE_PROTECT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICICLE_CRASH, MOVE_IRON_HEAD, MOVE_EARTHQUAKE, MOVE_CURSE}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICICLE_CRASH, MOVE_EARTHQUAKE, MOVE_HAIL, MOVE_ICE_SHARD}
    },
    {
    .iv = 250,
    .lvl = 52,
    .species = SPECIES_NINETALES_ALOLAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_CONFUSE_RAY, MOVE_HAIL, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SURF, MOVE_BODY_SLAM, MOVE_ICE_BEAM, MOVE_RAIN_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_DRAGON_CLAW, MOVE_DRAGON_DANCE, MOVE_IRON_TAIL}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_DRAGON_PULSE, MOVE_SURF, MOVE_TOXIC}
    },
    {
    .iv = 250,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_WITHDRAW, MOVE_ROCK_SLIDE, MOVE_BUG_BITE}
    },
    {
    .iv = 200,
    .lvl = 13,
    ...
    .moves = {MOVE_BLOCK, MOVE_HARDEN, MOVE_TACKLE, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POISON_STING, MOVE_LOW_KICK, MOVE_SEISMIC_TOSS, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 16,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_ELECTRIKE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SPARK, MOVE_LEER, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 220,
    .lvl = 22,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUPERSONIC, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_BUBBLE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 24,
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE, MOVE_THUNDER_FANG, MOVE_HOWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY, MOVE_SUNNY_DAY}
    },
    {
    .iv = 250,
    .lvl = 26,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_TAKE_DOWN, MOVE_SUNNY_DAY, MOVE_MAGNITUDE}
    },
    {
    .iv = 250,
    .lvl = 30,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_SUNNY_DAY, MOVE_THUNDER_PUNCH, MOVE_WILL_O_WISP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_VIGOROTH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLASH, MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_FEINT_ATTACK}
    },
    {
    .iv = 200,
    .lvl = 29,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PURSUIT, MOVE_BELLY_DRUM, MOVE_GIGA_IMPACT, MOVE_HEADBUTT}
    },
    {
    .iv = 250,
    .lvl = 31,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SLACK_OFF, MOVE_BRICK_BREAK, MOVE_GIGA_IMPACT, MOVE_FEINT_ATTACK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PERISH_SONG, MOVE_MIRROR_MOVE, MOVE_SAFEGUARD, MOVE_DUAL_WINGBEAT}
    },
    {
    .iv = 210,
    .lvl = 29,
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_DUAL_WINGBEAT, MOVE_SOLAR_BEAM, MOVE_SYNTHESIS}
    },
    {
    .iv = 210,
    .lvl = 30,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_GUN, MOVE_SUPERSONIC, MOVE_PROTECT, MOVE_DUAL_WINGBEAT}
    },
    {
    .iv = 220,
    .lvl = 31,
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_FURY_ATTACK, MOVE_STEEL_WING, MOVE_DUAL_WINGBEAT}
    },
    {
    .iv = 255,
    .lvl = 33,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE, MOVE_DUAL_WINGBEAT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTH_POWER, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 250,
    .lvl = 41,
    ...
    .species = SPECIES_SOLROCK,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM, MOVE_CALM_MIND, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_PSYCHIC, MOVE_COSMIC_POWER, MOVE_THUNDERBOLT}
    },
    {
    .iv = 200,
    .lvl = 41,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_HYDRO_PUMP, MOVE_ICE_PUNCH, MOVE_EARTHQUAKE}
    },
    {
    .iv = 200,
    .lvl = 44,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BANEFUL_BUNKER, MOVE_TOXIC, MOVE_SLUDGE_BOMB, MOVE_HYDRO_PUMP}
    },
    {
    .iv = 200,
    .lvl = 44,
    .species = SPECIES_CRAWDAUNT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_NIGHT_SLASH, MOVE_CRABHAMMER, MOVE_TAUNT, MOVE_HONE_CLAWS}
    },
    {
    .iv = 250,
    .lvl = 46,
    ...
    .moves = {MOVE_HYDRO_PUMP, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_REST}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .lvl = 10,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_TACKLE, MOVE_ROCK_THROW, MOVE_DEFENSE_CURL, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .moves = {MOVE_THUNDER_SHOCK, MOVE_CHARM, MOVE_SWEET_KISS, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 150,
    .lvl = 18,
    .species = SPECIES_PLUSLE,
    .moves = {MOVE_NUZZLE, MOVE_SHOCK_WAVE, MOVE_SWIFT, MOVE_ENCORE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Quincy[] = {
    ...
    .lvl = 43,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_SLACK_OFF, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 100,
    .lvl = 43,
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .lvl = 43,
    .species = SPECIES_SLAKING,
    .moves = {MOVE_EARTHQUAKE, MOVE_SHADOW_CLAW, MOVE_SLACK_OFF, MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_SPOUT, MOVE_NOBLE_ROAR, MOVE_BLIZZARD}
    },
    {
    .iv = 255,
    .lvl = 55,
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_SURF, MOVE_SLUDGE_BOMB, MOVE_BARRIER}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENERGY_BALL, MOVE_SURF, MOVE_LEECH_SEED, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_PRIMARINA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_SPARKLING_ARIA, MOVE_AMNESIA, MOVE_AQUA_RING}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonNoItemCustomMoves sParty_TabithaMossdeep[] = {
    ...
    .lvl = 41,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_CRUSH_CLAW, MOVE_ROCK_SLIDE, MOVE_SAND_ATTACK}
    },
    {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_GLISCOR,
    .moves = {MOVE_DIG, MOVE_DUAL_WINGBEAT, MOVE_THUNDER_FANG, MOVE_SCREECH}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_EXCADRILL,
    .moves = {MOVE_DRILL_RUN, MOVE_IRON_HEAD, MOVE_HONE_CLAWS, MOVE_IRON_DEFENSE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 44,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_AIR_SLASH, MOVE_SAFEGUARD, MOVE_DRAGON_PULSE, MOVE_COTTON_GUARD}
    },
    {
    .iv = 150,
    .lvl = 43,
    .species = SPECIES_CLEFABLE,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_COSMIC_POWER, MOVE_MOONLIGHT, MOVE_FLAMETHROWER}
    },
    {
    .iv = 150,
    .lvl = 42,
    .species = SPECIES_FROSLASS,
    .moves = {MOVE_ICE_BEAM, MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_PAIN_SPLIT}
    },
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_ROSERADE,
    .moves = {MOVE_ENERGY_BALL, MOVE_LEECH_SEED, MOVE_SLUDGE_BOMB, MOVE_TOXIC}
    },
    {
    .iv = 150,
    .lvl = 42,
    .species = SPECIES_MAGNEZONE,
    .moves = {MOVE_SUPERSONIC, MOVE_THUNDERBOLT, MOVE_FLASH_CANNON, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 250,
    .lvl = 45,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_BULK_UP, MOVE_PSYCHO_CUT, MOVE_BRICK_BREAK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GruntSeafloorCavern5[] = {
    ...
    .lvl = 35,
    .species = SPECIES_CARVANHA,
    .moves = {MOVE_AQUA_JET, MOVE_ASSURANCE, MOVE_ICE_FANG, MOVE_SWAGGER}
    },
    {
    .iv = 50,
    .lvl = 35,
    .species = SPECIES_PELIPPER,
    .moves = {MOVE_SURF, MOVE_AIR_SLASH, MOVE_SUPERSONIC, MOVE_ICE_BEAM}
    },
    {
    .iv = 50,
    .lvl = 35,
    .species = SPECIES_ARAQUANID,
    .moves = {MOVE_WATERFALL, MOVE_X_SCISSOR, MOVE_CRUNCH, MOVE_AQUA_RING}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TabithaMtChimney[] = {
    ...
    .lvl = 19,
    .species = SPECIES_SANDSHREW,
    .moves = {MOVE_MAGNITUDE, MOVE_FURY_CUTTER, MOVE_ROLLOUT, MOVE_POISON_STING}
    },
    {
    .iv = 50,
    .lvl = 22,
    .species = SPECIES_DRILBUR,
    .moves = {MOVE_DIG, MOVE_METAL_CLAW, MOVE_HONE_CLAWS, MOVE_MUD_SLAP}
    },
    {
    .iv = 50,
    .lvl = 20,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_FLAME_BURST, MOVE_MAGNITUDE, MOVE_AMNESIA, MOVE_GROWL}
    },
    {
    .iv = 50,
    .lvl = 21,
    .species = SPECIES_GLIGAR,
    .moves = {MOVE_FEINT_ATTACK, MOVE_POISON_STING, MOVE_QUICK_ATTACK, MOVE_SAND_ATTACK}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MaxieMagmaHideout[] = {
    ...
    .lvl = 37,
    .species = SPECIES_KROKOROK,
    .moves = {MOVE_DIG, MOVE_CRUNCH, MOVE_SCARY_FACE, MOVE_SWAGGER}
    },
    {
    .iv = 150,
    .lvl = 38,
    .species = SPECIES_GLIGAR,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_SLASH, MOVE_X_SCISSOR, MOVE_SCREECH}
    },
    {
    .iv = 150,
    .lvl = 38,
    .species = SPECIES_VIBRAVA,
    .moves = {MOVE_EARTH_POWER, MOVE_DRAGON_BREATH, MOVE_BUG_BUZZ, MOVE_SANDSTORM}
    },
    {
    .iv = 150,
    .lvl = 38,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_DIG, MOVE_CRUSH_CLAW, MOVE_POISON_STING, MOVE_GYRO_BALL}
    },
    {
    .iv = 150,
    .lvl = 38,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_EARTH_POWER, MOVE_EXTRASENSORY, MOVE_COSMIC_POWER, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 150,
    .lvl = 39,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_LAVA_PLUME, MOVE_EARTH_POWER, MOVE_YAWN, MOVE_AMNESIA}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MaxieMtChimney[] = {
    ...
    .lvl = 24,
    .species = SPECIES_SANDILE,
    .moves = {MOVE_SAND_TOMB, MOVE_ASSURANCE, MOVE_TORMENT, MOVE_SAND_ATTACK}
    },
    {
    .iv = 150,
    .lvl = 25,
    .species = SPECIES_TRAPINCH,
    .moves = {MOVE_DIG, MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_SAND_ATTACK}
    },
    {
    .iv = 150,
    .lvl = 26,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_EARTH_POWER, MOVE_LAVA_PLUME, MOVE_AMNESIA, MOVE_GROWL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .moves = {MOVE_FLAME_BURST, MOVE_POISON_GAS, MOVE_SMOG, MOVE_SWAGGER}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .moves = {MOVE_KARATE_CHOP, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 18,
    .species = SPECIES_ELEKID,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_BRICK_BREAK, MOVE_QUICK_ATTACK, MOVE_MEDITATE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .moves = {MOVE_MEGA_PUNCH, MOVE_WILL_O_WISP, MOVE_BRICK_BREAK, MOVE_FIRE_PUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyMauville[] = {
    ...
    .lvl = 20,
    .species = SPECIES_KIRLIA,
    .moves = {MOVE_CONFUSION, MOVE_DRAINING_KISS, MOVE_DOUBLE_TEAM, MOVE_GROWL}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR3[] = {
    ...
    .lvl = 49,
    .species = SPECIES_CLEFABLE,
    .moves = {MOVE_MOONBLAST, MOVE_COSMIC_POWER, MOVE_MOONLIGHT, MOVE_FLAMETHROWER}
    },
    {
    .iv = 150,
    .lvl = 48,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR4[] = {
    ...
    .lvl = 54,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_REFLECT, MOVE_BULK_UP, MOVE_ZEN_HEADBUTT, MOVE_CLOSE_COMBAT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TabithaMagmaHideout[] = {
    ...
    .lvl = 26,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_MAGNITUDE, MOVE_CRUSH_CLAW, MOVE_ROLLOUT, MOVE_SAND_ATTACK}
    },
    {
    .iv = 75,
    .lvl = 28,
    .species = SPECIES_GLIGAR,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_SLASH, MOVE_FEINT_ATTACK, MOVE_SAND_ATTACK}
    },
    {
    .iv = 75,
    .lvl = 30,
    .species = SPECIES_NUMEL,
    .moves = {MOVE_LAVA_PLUME, MOVE_EARTH_POWER, MOVE_AMNESIA, MOVE_GROWL}
    },
    {
    .iv = 75,
    .lvl = 33,
    .species = SPECIES_EXCADRILL,
    .moves = {MOVE_DRILL_RUN, MOVE_IRON_HEAD, MOVE_HONE_CLAWS, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_MaxieMossdeep[] = {
    {
    .iv = 150,
    .lvl = 42,
    .species = SPECIES_KROOKODILE,
    ...
    .lvl = 43,
    .species = SPECIES_FLYGON,
    .moves = {MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_SCREECH, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 150,
    .lvl = 44,
    .species = SPECIES_CAMERUPT,
    .moves = {MOVE_EARTH_POWER, MOVE_LAVA_PLUME, MOVE_AMNESIA, MOVE_YAWN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_POWER_GEM, MOVE_STEALTH_ROCK, MOVE_LIGHT_SCREEN, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = 255,
    .lvl = 35,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SHELL_SMASH, MOVE_IRON_DEFENSE, MOVE_X_SCISSOR, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 32,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_IRON_HEAD, MOVE_EXPLOSION, MOVE_PROTECT, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_ICE_BEAM, MOVE_POWER_GEM, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 42,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRICK_BREAK, MOVE_SUCKER_PUNCH, MOVE_PROTECT, MOVE_POISON_JAB}
    },
    {
    .iv = 255,
    .lvl = 37,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_PROTECT, MOVE_DRAIN_PUNCH, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .species = SPECIES_TOXICROAK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_SUCKER_PUNCH, MOVE_PROTECT, MOVE_GUNK_SHOT}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly5[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_BLAZE_KICK, MOVE_BULLET_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 255,
    .lvl = 46,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_THUNDER, MOVE_THUNDER_WAVE, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 38,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_VOLT_TACKLE, MOVE_SLAM, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .species = SPECIES_MAGNEZONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUPERSONIC, MOVE_FLASH_CANNON, MOVE_THUNDER, MOVE_RAIN_DANCE}
    },
    {
    .iv = 255,
    .lvl = 45,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson5[] = {
    ...
    .species = SPECIES_ELECTIVIRE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_VOLT_TACKLE, MOVE_CROSS_CHOP, MOVE_EARTHQUAKE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .species = SPECIES_MAGMAR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLARE_BLITZ, MOVE_THUNDER_PUNCH, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 38,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HELPING_HAND, MOVE_FLARE_BLITZ, MOVE_ROAR, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery4[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_TAUNT, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HELPING_HAND, MOVE_FLARE_BLITZ, MOVE_SUNNY_DAY, MOVE_ROAR}
    },
    {
    .iv = 255,
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_BLAST, MOVE_THUNDERBOLT, MOVE_SOLAR_BEAM, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_GIGA_IMPACT, MOVE_BRICK_BREAK, MOVE_FEINT_ATTACK, MOVE_SLACK_OFF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = {
    ...
    .species = SPECIES_TROPIUS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUNNY_DAY, MOVE_AIR_SLASH, MOVE_SOLAR_BEAM, MOVE_SYNTHESIS}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WHIRLWIND, MOVE_SPIKES, MOVE_IRON_HEAD, MOVE_DRILL_PECK}
    },
    {
    .iv = 255,
    .lvl = 45,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_REST, MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona3[] = {
    ...
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STONE_EDGE, MOVE_DUAL_WINGBEAT, MOVE_ROOST, MOVE_THUNDER_FANG}
    },
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza2[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTH_POWER, MOVE_COSMIC_POWER, MOVE_PSYCHIC, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 255,
    .lvl = 49,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza3[] = {
    ...
    .species = SPECIES_ORBEETLE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_PSYCHIC, MOVE_BUG_BUZZ, MOVE_CALM_MIND}
    },
    {
    .iv = 255,
    .lvl = 53,
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = {
    ...
    .species = SPECIES_POLIWRATH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_RAIN_DANCE, MOVE_WATERFALL, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_SURF, MOVE_DOUBLE_TEAM, MOVE_DRAGON_PULSE, MOVE_REST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Angelo[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_BUG_BITE, MOVE_STRING_SHOT, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 18,
    .species = SPECIES_JOLTIK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ELECTROWEB, MOVE_SIGNAL_BEAM, MOVE_THUNDER_WAVE, MOVE_ABSORB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Steven[] = {
    ...
    .moves = {MOVE_IRON_HEAD, MOVE_NIGHT_SLASH, MOVE_BRICK_BREAK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 76,
    ...
    .moves = {MOVE_IRON_TAIL, MOVE_EARTHQUAKE, MOVE_SCREECH, MOVE_CRUNCH}
    },
    {
    .iv = 255,
    .lvl = 76,
    ...
    .moves = {MOVE_DOUBLE_IRON_BASH, MOVE_ICE_PUNCH, MOVE_ACID_ARMOR, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 78,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_BULLET_PUNCH, MOVE_IRON_DEFENSE}
    }
};
