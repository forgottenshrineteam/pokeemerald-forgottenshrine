const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]             = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                                       {EVO_ITEM_HOLD_DAY, ITEM_KINGS_ROCK, SPECIES_POLITOED},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_KINGS_ROCK, SPECIES_POLITOED}},
    ...
    [SPECIES_GRAVELER]              = {{EVO_LEVEL, 40, SPECIES_GOLEM},
                                       {EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_GRAVELER_ALOLAN},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_GOLEM_ALOLAN}},
    [SPECIES_GOLEM]                 = {{EVO_MAPSEC, MAPSEC_NEW_MAUVILLE, SPECIES_GOLEM_ALOLAN},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_GOLEM_ALOLAN}},
    [SPECIES_PONYTA]                = {{EVO_LEVEL, 40, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]              = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                                       {EVO_ITEM_HOLD_DAY, ITEM_KINGS_ROCK, SPECIES_SLOWKING},
    ...
    [SPECIES_RHYDON]                = {{EVO_ITEM_HOLD_DAY, ITEM_PROTECTOR, SPECIES_RHYPERIOR},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_PROTECTOR, SPECIES_RHYPERIOR}},
    ...
    [SPECIES_SEADRA]                = {{EVO_ITEM_HOLD_DAY, ITEM_DRAGON_SCALE, SPECIES_KINGDRA},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_DRAGON_SCALE, SPECIES_KINGDRA}},
    ...
    [SPECIES_ELECTABUZZ]            = {{EVO_ITEM_HOLD_DAY, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_ELECTIRIZER, SPECIES_ELECTIVIRE}},
    [SPECIES_MAGMAR]                = {{EVO_ITEM_HOLD_DAY, ITEM_MAGMARIZER, SPECIES_MAGMORTAR},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_MAGMARIZER, SPECIES_MAGMORTAR}},
    ...
    [SPECIES_GLIGAR]                = {{EVO_ITEM_HOLD_NIGHT, ITEM_RAZOR_FANG, SPECIES_GLISCOR},
                                       {EVO_ITEM_HOLD_DAY, ITEM_RAZOR_FANG, SPECIES_GLISCOR}},
    ...
    [SPECIES_SNEASEL]               = {{EVO_ITEM_HOLD_NIGHT, ITEM_RAZOR_CLAW, SPECIES_WEAVILE},
                                       {EVO_ITEM_HOLD_DAY, ITEM_RAZOR_CLAW, SPECIES_WEAVILE}},
    [SPECIES_TEDDIURSA]             = {{EVO_LEVEL, 30, SPECIES_URSARING}},
    [SPECIES_SLUGMA]                = {{EVO_LEVEL, 38, SPECIES_MAGCARGO}},
    [SPECIES_SWINUB]                = {{EVO_LEVEL, 33, SPECIES_PILOSWINE}},
    [SPECIES_CORSOLA]               = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_CURSOLA}},
    ...
    [SPECIES_LINOONE]               = {{EVO_LEVEL_DARK_TYPE_MON_IN_PARTY, 21, SPECIES_LINOONE_GALARIAN}},
    ...
    [SPECIES_DUSCLOPS]              = {{EVO_ITEM_HOLD_DAY, ITEM_REAPER_CLOTH, SPECIES_DUSKNOIR},
                                       {EVO_ITEM_HOLD_NIGHT, ITEM_REAPER_CLOTH, SPECIES_DUSKNOIR}},
    ...
    [SPECIES_CLAMPERL]              = {{EVO_ITEM_HOLD_NIGHT, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL},
                                       {EVO_ITEM_HOLD_DAY, ITEM_DEEP_SEA_SCALE, SPECIES_GOREBYSS}},
    ...
    [SPECIES_MELTAN]                = {{EVO_MOVE, MOVE_BULLET_PUNCH, SPECIES_MELMETAL}},
