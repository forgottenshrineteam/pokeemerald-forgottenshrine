...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_NINETALES]          = BACK_ANIM_SHAKE_GLOW_RED,
    ...
    [SPECIES_TURTWIG]            = BACK_ANIM_V_STRETCH,
    [SPECIES_GROTLE]             = BACK_ANIM_H_SLIDE,
    [SPECIES_TORTERRA]           = BACK_ANIM_V_SHAKE,
    [SPECIES_BUDEW]              = BACK_ANIM_H_SPRING,
    [SPECIES_ROSERADE]           = BACK_ANIM_SHAKE_GLOW_GREEN,
    [SPECIES_MISMAGIUS]          = BACK_ANIM_H_VIBRATE,
    [SPECIES_HONCHKROW]          = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_CHINGLING]          = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_CROAGUNK]           = BACK_ANIM_H_SLIDE,
    [SPECIES_TOXICROAK]          = BACK_ANIM_V_STRETCH,
    [SPECIES_WEAVILE]            = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_MAGNEZONE]          = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_RHYPERIOR]          = BACK_ANIM_GROW,
    [SPECIES_TANGROWTH]          = BACK_ANIM_SHRINK_GROW,
    [SPECIES_ELECTIVIRE]         = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_MAGMORTAR]          = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_TOGEKISS]           = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_YANMEGA]            = BACK_ANIM_H_VIBRATE,
    [SPECIES_LEAFEON]            = BACK_ANIM_V_SHAKE,
    [SPECIES_GLACEON]            = BACK_ANIM_V_STRETCH,
    [SPECIES_GLISCOR]            = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_MAMOSWINE]          = BACK_ANIM_V_SHAKE,
    [SPECIES_GALLADE]            = BACK_ANIM_SHRINK_GROW,
    [SPECIES_PROBOPASS]          = BACK_ANIM_H_SPRING,
    [SPECIES_DUSKNOIR]           = BACK_ANIM_H_VIBRATE,
    [SPECIES_FROSLASS]           = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_ROGGENROLA]         = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_BOLDORE]            = BACK_ANIM_SHRINK_GROW,
    [SPECIES_GIGALITH]           = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_DRILBUR]            = BACK_ANIM_V_STRETCH,
    [SPECIES_EXCADRILL]          = BACK_ANIM_SHRINK_GROW,
    [SPECIES_TYMPOLE]            = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_PALPITOAD]          = BACK_ANIM_V_STRETCH,
    [SPECIES_SEISMITOAD]         = BACK_ANIM_H_STRETCH,
    [SPECIES_SEWADDLE]           = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_SWADLOON]           = BACK_ANIM_V_SHAKE,
    [SPECIES_LEAVANNY]           = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_SANDILE]            = BACK_ANIM_H_SHAKE,
    [SPECIES_KROKOROK]           = BACK_ANIM_V_STRETCH,
    [SPECIES_KROOKODILE]         = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_MARACTUS]           = BACK_ANIM_H_SHAKE,
    [SPECIES_DWEBBLE]            = BACK_ANIM_H_SHAKE,
    [SPECIES_CRUSTLE]            = BACK_ANIM_GROW_STUTTER,
    [SPECIES_SCRAGGY]            = BACK_ANIM_V_STRETCH,
    [SPECIES_SCRAFTY]            = BACK_ANIM_SHRINK_GROW,
    [SPECIES_FRILLISH]           = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_JELLICENT]          = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_JOLTIK]             = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GALVANTULA]         = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_LITWICK]            = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_LAMPENT]            = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_CHANDELURE]         = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_AXEW]               = BACK_ANIM_H_SHAKE,
    [SPECIES_FRAXURE]            = BACK_ANIM_SHRINK_GROW,
    [SPECIES_HAXORUS]            = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_FENNEKIN]           = BACK_ANIM_V_SHAKE,
    [SPECIES_BRAIXEN]            = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_DELPHOX]            = BACK_ANIM_V_STRETCH,
    [SPECIES_SKRELP]             = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_DRAGALGE]           = BACK_ANIM_SHRINK_GROW,
    [SPECIES_SYLVEON]            = BACK_ANIM_H_STRETCH,
    [SPECIES_CARBINK]            = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_PHANTUMP]           = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_TREVENANT]          = BACK_ANIM_H_SLIDE,
    [SPECIES_NOIBAT]             = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_NOIVERN]            = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_POPPLIO]            = BACK_ANIM_V_STRETCH,
    [SPECIES_BRIONNE]            = BACK_ANIM_SHRINK_GROW,
    [SPECIES_PRIMARINA]          = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_GRUBBIN]            = BACK_ANIM_H_SLIDE,
    [SPECIES_CHARJABUG]          = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_VIKAVOLT]           = BACK_ANIM_H_VIBRATE,
    [SPECIES_CRABRAWLER]         = BACK_ANIM_V_SHAKE,
    [SPECIES_CRABOMINABLE]       = BACK_ANIM_SHRINK_GROW,
    [SPECIES_CUTIEFLY]           = BACK_ANIM_H_SHAKE,
    [SPECIES_RIBOMBEE]           = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_ROCKRUFF]           = BACK_ANIM_V_STRETCH,
    [SPECIES_LYCANROC]           = BACK_ANIM_V_SHAKE,
    [SPECIES_MAREANIE]           = BACK_ANIM_H_SHAKE,
    [SPECIES_TOXAPEX]            = BACK_ANIM_H_STRETCH,
    [SPECIES_DEWPIDER]           = BACK_ANIM_SHRINK_GROW,
    [SPECIES_ARAQUANID]          = BACK_ANIM_H_SHAKE,
    [SPECIES_SALANDIT]           = BACK_ANIM_V_SHAKE,
    [SPECIES_SALAZZLE]           = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_WIMPOD]             = BACK_ANIM_V_SHAKE_H_SLIDE,
    [SPECIES_GOLISOPOD]          = BACK_ANIM_SHRINK_GROW,
    [SPECIES_MELTAN]             = BACK_ANIM_GROW_STUTTER,
    [SPECIES_MELMETAL]           = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_BLIPBUG]            = BACK_ANIM_V_STRETCH,
    [SPECIES_DOTTLER]            = BACK_ANIM_H_SHAKE,
    [SPECIES_ORBEETLE]           = BACK_ANIM_CIRCLE_COUNTERCLOCKWISE,
    [SPECIES_OBSTAGOON]          = BACK_ANIM_SHRINK_GROW,
    [SPECIES_ROLYCOLY]           = BACK_ANIM_H_SHAKE,
    [SPECIES_CARKOL]             = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_COALOSSAL]          = BACK_ANIM_SHRINK_GROW,
    [SPECIES_TOXEL]              = BACK_ANIM_H_STRETCH,
    [SPECIES_TOXTRICITY]         = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_SIZZLIPEDE]         = BACK_ANIM_H_SLIDE,
    [SPECIES_CENTISKORCH]        = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_CURSOLA]            = BACK_ANIM_SHRINK_GROW,
    [SPECIES_LYCANROC_MIDNIGHT]  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_LYCANROC_DUSK]      = BACK_ANIM_V_SHAKE,
    [SPECIES_TOXTRICITY_LOW_KEY] = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_SANDSLASH_ALOLAN]   = BACK_ANIM_V_STRETCH,
    [SPECIES_NINETALES_ALOLAN]   = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_GEODUDE_ALOLAN]     = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_GRAVELER_ALOLAN]    = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_GOLEM_ALOLAN]       = BACK_ANIM_SHAKE_FLASH_YELLOW,
    [SPECIES_ZIGZAGOON_GALARIAN] = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_LINOONE_GALARIAN]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CORSOLA_GALARIAN]   = BACK_ANIM_H_SLIDE,
};
