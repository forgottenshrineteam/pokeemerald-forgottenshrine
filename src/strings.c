...
const u8 gText_TM32AndPrice[] = _("TM30{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM29AndPrice[] = _("TM29{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM35AndPrice[] = _("TM35{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM24AndPrice[] = _("TM24{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM13AndPrice[] = _("TM13{CLEAR_TO 0x48}1,000 COINS");
